...
import React from "react";
import { FaReact, FaFigma, FaNodeJs, FaGitAlt, FaJs, FaBootstrap, FaTrello, FaTerminal, FaRobot, FaBrain, FaSlack, } from "react-icons/fa";
import { SiGoogle, SiGooglemeet, SiGmail, SiGoogledocs, SiGooglesheets, SiGoogleforms, SiGoogleads, SiCanva, SiTailwindcss, SiMicrosoftonenote, SiMicrosoftoutlook, SiMicrosoftteams, SiMicrosoftword, SiMicrosoftexcel, SiMicrosoftpowerpoint, SiMicrosoft, SiGooglecalendar, SiGoogleslides, SiGithub, SiZoom, SiHootsuite } from "react-icons/si";
import { MdOutlineCalendarToday } from "react-icons/md";  // Importing calendar icon
